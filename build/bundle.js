...
/***/ function(module, exports, __webpack_require__) {
	...
	const reducer_1 = __webpack_require__(28);
	const App_1 = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const redux_actions_1 = __webpack_require__(29);
	const actions_1 = __webpack_require__(178);
	const generateTiles_1 = __webpack_require__(179);
	const generatePlayers_1 = __webpack_require__(180);
	const Tile_1 = __webpack_require__(182);
	...
	exports.default = redux_actions_1.handleActions({
	    [actions_1.GENERATE_MAP]: state => assign({}, state, {
	        tiles: generateTiles_1.generateTiles({ width: state.mapWidth, height: state.mapHeight }),
	    }),
	    [actions_1.GENERATE_PLAYERS]: state => {
	        const players = generatePlayers_1.generatePlayers({ tiles: state.tiles, playersAmount: state.playersAmount })
	            .map(p => assign({}, p, {
	            seenTiles: Tile_1.getSurroundingTiles(state.tiles, p.units.map(u => u.tile), state.mapWidth, state.mapHeight)
	        }));
	        console.log(players);
	        const currentPlayer = players[0];
	        const selectedUnit = currentPlayer.units[0];
	        const firstUnitTile = Tile_1.getTilePosition(selectedUnit.tile);
	        return assign({}, state, {
	            selectedUnitIndex: 0,
	            players: players,
	    ...
	    [actions_1.MAYBE_MOVE_TO]: (state, action) => {
	        ...
	        const currentPlayerAfterSeenTiles = assign({}, currentPlayerAfterMovedUnit, {
	            seenTiles: lodash_1.uniq([
	                ...
	                ...Tile_1.getSurroundingTiles(state.tiles, currentPlayerAfterMovedUnit.units.map(u => u.tile), state.mapWidth, state.mapHeight)
	            ])
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createAction = __webpack_require__(30);
	
	var _createAction2 = _interopRequireDefault(_createAction);
	
	var _handleAction = __webpack_require__(32);
	
	var _handleAction2 = _interopRequireDefault(_handleAction);
	
	var _handleActions = __webpack_require__(83);
	
	var _handleActions2 = _interopRequireDefault(_handleActions);
	
	var _combineActions = __webpack_require__(60);
	
	var _combineActions2 = _interopRequireDefault(_combineActions);
	
	var _createActions = __webpack_require__(86);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _includes = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toString = __webpack_require__(80);
	
	var _toString2 = _interopRequireDefault(_toString);
	
	var _isSymbol = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ownKeys = __webpack_require__(84);
	
	var _ownKeys2 = _interopRequireDefault(_ownKeys);
	
	var _reduceReducers = __webpack_require__(85);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _camelCase = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var capitalize = __webpack_require__(88),
	    createCompounder = __webpack_require__(97);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toString = __webpack_require__(80),
	    upperFirst = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var castSlice = __webpack_require__(91),
	    hasUnicode = __webpack_require__(93),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var asciiToArray = __webpack_require__(95),
	    hasUnicode = __webpack_require__(93),
	    unicodeToArray = __webpack_require__(96);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var basePropertyOf = __webpack_require__(101);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var asciiWords = __webpack_require__(103),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.moveCamera = redux_actions_1.createAction(exports.MOVE_CAMERA, ({ x, y }) => ({ x: x, y: y }));
	exports.nextTurn = redux_actions_1.createAction(exports.NEXT_TURN);
	exports.maybeMoveTo = redux_actions_1.createAction(exports.MAYBE_MOVE_TO, tile => ({ tile: tile }));
...
/***/ function(module, exports) {
	...
	"use strict";
	function generatePlayers({ tiles, playersAmount }) {
	    const players = [];
	    let nextId = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Tile_1 = __webpack_require__(182);
	const MAP_SPEED = 10;
	exports.TileComponent = ({ tile, className, onClick }) => (React.createElement("svg", {onClick: onClick, className: className, viewBox: '0 20 300 280', width: Tile_1.TILE_WIDTH, style: Tile_1.getTilePosition(tile)}, React.createElement("polygon", {points: "300,150 225,280 75,280 0,150 75,20 225,20"})));
	class App extends React.Component {
	    constructor(props) {
	        super();
	        props.dispatch(actions_1.generateMap());
	    ...
	    updatePosition() {
	        ...
	        if (position.x || position.y) {
	            this.props.dispatch(actions_1.moveCamera(position));
	        }
	    ...
	    render() {
	        ...
	        return (React.createElement("div", {className: 'app'}, React.createElement("div", {className: 'map'}, React.createElement("div", {className: 'map-content', style: { marginLeft: -camera.x + window.innerWidth / 2 - Tile_1.TILE_WIDTH / 2, marginTop: -camera.y + window.innerHeight / 2 - Tile_1.TILE_HEIGHT / 2 }}, currentPlayer && currentPlayer.seenTiles.filter(tile => Tile_1.isTileVisible(tile, camera)).map(tile => React.createElement(exports.TileComponent, {tile: tile, key: tile.id, className: 'tile', onClick: () => dispatch(actions_1.maybeMoveTo(tile))})), players.map(player => player.units.filter(unit => currentPlayer.seenTiles.map(t => t.id).indexOf(unit.tile.id) > -1).map(unit => {
	            const className = 'unit' + (player === currentPlayer ? ' my-unit' : '');
	            return React.createElement(exports.TileComponent, {tile: unit.tile, key: unit.tile.id, className: className, onClick: () => { }});
	        })))), React.createElement("div", {className: 'board'}, React.createElement("span", null, 'currentPlayer: ' + (currentPlayer && currentPlayer.id)), React.createElement("span", null, 'Turn: ' + turn), React.createElement("button", {onClick: () => dispatch(actions_1.nextTurn())}, " Next turn"), React.createElement("span", null, 'Selected unit: ' + (selectedUnitIndex && currentPlayer.units[selectedUnitIndex].name)))));
	    }
	}
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports) {
	...
	"use strict";
	exports.TILE_HEIGHT = 100 * Math.sqrt(3) / 2;
	exports.TILE_WIDTH = 100;
	function getTilePosition(tile) {
	    return tile.position.x % 2 == 0 ? ({
	        left: tile.position.x * exports.TILE_WIDTH * 3 / 4,
	        top: tile.position.y * exports.TILE_HEIGHT,
	    }) : ({
	        left: tile.position.x * exports.TILE_WIDTH * 3 / 4,
	        top: tile.position.y * exports.TILE_HEIGHT + exports.TILE_HEIGHT / 2,
	    });
	}
	exports.getTilePosition = getTilePosition;
	function isTileVisible(tile, camera) {
	    const position = getTilePosition(tile);
	    const left = position.left - camera.x + window.innerWidth / 2 - exports.TILE_WIDTH / 2;
	    const top = position.top - camera.y + window.innerHeight / 2 - exports.TILE_HEIGHT / 2;
	    return (left < window.innerWidth &&
	        top < window.innerHeight &&
	        left > -exports.TILE_WIDTH &&
	        top > -exports.TILE_HEIGHT);
	}
	exports.isTileVisible = isTileVisible;
	function getSurroundingTiles(allTiles, tiles, mapWidth, mapHeight) {
